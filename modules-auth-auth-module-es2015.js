...
let LoginComponent = class LoginComponent {
    constructor(formBuilder, storageService, authService, router, snackBar) {
    ...
    onLogin() {
        const subId = this.authService
            .login(this.loginForm.getRawValue().email, this.loginForm.getRawValue().password)
            .subscribe((user) => {
            this.storageService.setUser(user);
            this.router.navigate([___WEBPACK_IMPORTED_MODULE_7__["Constants"].ROUTERS.EMPTY]);
        }, (error) => {
